package ru.mirea.task19.Number2;
...
class Main {
    public static void main(String[] args) {
        ...
        Student[] students = {
                new StudentImpl("Ильеня Михаил Алексеевич", 4.5),
                new StudentImpl("Лампов Алексей Геннадьевич", 3.8),
                new StudentImpl("Рубанов Илья Александрович", 4.2)
        };
